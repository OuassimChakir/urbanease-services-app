...
import { ServiceCategoryEntity } from '../../migrations/service-category.entity';
  ...
  export class ServiceCategoriesController {
    ...
    @Get(':id')
    async getServiceCategoryById(@Param('id') id: number): Promise<ServiceCategoryEntity> {
    ...
    async createServiceCategory(
      ...
      return await this.serviceCategoriesService.createServiceCategory(serviceCategory);
    }
    ...
    async updateServiceCategory(
      ...
      return await this.serviceCategoriesService.updateServiceCategory(id, serviceCategory);
    }
